...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		<a href="<?php echo  base_url("admin/sms_history"); ?>" class="btn btn-primary"><i class="flaticon2-back-1"></i>Back</a>
	</div>	
</div>		</div>
	</div>
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
								    ...
								    <tbody>
                                          <?php //$no = 1; ?>
						<?php foreach ($data_sms as $historys): ?>
									  <tr>
                    ...
                    <tr>
                   <th>TOTAL</th>
                   <th><?php echo $total_sms->total_sms; ?></th>
                    </tr>
                   </tfoot>
                   </table>
		<!--end: Datatable -->
