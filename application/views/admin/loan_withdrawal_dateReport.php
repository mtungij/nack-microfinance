...
<table>
 ...
 <tr>
    ...
    <td style="font-size:12px;border: none;" class="c"><?php echo number_format($loan_withdrawals->with_amount); ?></td>
    <td style="font-size:12px;border: none;"><?php echo $loan_withdrawals->method; ?></td>
