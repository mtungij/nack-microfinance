...
<?php }else{ ?>
 ...
 <div class="col-lg-12">
  ...
  <!-- <form class="form-horizontal" action="<?php //site_url()?>create_sponser/{$customer->customer_code}" method="post"> -->
    <?php echo form_open("admin/create_sponser/{$customer->customer_code}/{$customer->comp_id}",['class'=>'form-horizontal']) ?>
...
kt-menu__link-icon flaticon-add"></i>Add More</button>
    ...
    <div class="text-center">
     ...
     <?php if(@$sponser->customer_id == TRUE){ ?> 
     <a href="<?php echo base_url("admin/loan_applicationForm/{$sponser->customer_id}"); ?>" class="btn btn-primary btn-sm">Skip</a>
 <?php }else{ ?>
