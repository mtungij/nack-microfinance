...
<head>
  ...
  <style>
    ...
    th { background: #f44336; color: #fff; } /* Red header for 31–60 days */
    ...
    .grand-total { background: #f44336; color: #fff; padding: 10px; text-align: center; font-weight: bold; margin-top: 20px; border-radius: 6px; }
