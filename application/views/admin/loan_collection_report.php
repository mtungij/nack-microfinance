...
<p style="font-size:12px;text-align:center;" class="c">LOAN COLLECTIONS REPORT <?php //echo $day; ?></p>
...
<table>
  <tr>
    <th style="font-size:13px;border: none;">S/No.</th>
     <th style="font-size:13px;border: none;">Branch Name</th>
 ...
 <tr>
    ...
    <td style="font-size:12px;border: none;" class="c"><?php echo $loan_collections->blanch_name; ?> </td>
 ...
 <tr>
    ...
    <td style="font-size:12px;border: none;" class="c"><b><?php echo number_format($loan_total->total_loan); ?></b></td>
    ...
    <td style="font-size:12px;border: none;"><b>
      <?php if ($depost_loan->total_loan_depost > $loan_total->total_loan) {
       ?>
      <?php echo $loan_total->total_loan; ?> <b style="color: red;">(<?php echo $depost_loan->total_loan_depost - $loan_total->total_loan ?>)</b>
     <?php }else{ ?>
    ...
    <td style="font-size:12px;border: none;"><b>
      <?php if ($penart_paid->total_penart_paid > $penart->penart_amount) {
       ?>
       0 <b style="color:red;">(<?php echo $penart_paid->total_penart_paid -  $penart->penart_amount?>)</b>
     <?php }else{ ?>
