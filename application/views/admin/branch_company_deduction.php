...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		...
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				From Deduction Branch Account To Company Account
			</h3>
			&nbsp;&nbsp;&nbsp;
		</div>
		<?php echo form_close(); ?>
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
								    ...
								    <tbody>
                                          <?php $no = 1; ?>
									<?php foreach ($transaction as $transaction_lists): ?>
									          <tr>
				  					<td>
				  					...
				  					<td><?php echo $transaction_lists->blanch_name; ?></td>
				  					<td><?php echo number_format($transaction_lists->balance); ?></td>
				  					<td><?php echo $transaction_lists->account_name; ?></td>
				  					
				  					 <td><?php echo number_format($transaction_lists->trans_fee); ?></td>
				  					 <td>	<?php if ($transaction_lists->trans_user == TRUE) {
				  						 ?>
				  						<?php echo $transaction_lists->trans_user; ?>
				  					<?php }elseif($transaction_lists->trans_user == FALSE){ ?>
				  							Admin
				  							<?php } ?></td>
				  					<td>
				  					<?php echo $transaction_lists->trans_date; ?>
				  					</td>
                                    </tr>
	              ...
	              <!--   <tfoot>
                    <tr>
                   	<th>TOTAL</th>
				    <th></th>
				    <th><?php //echo number_format($total_transaction->total_blanch_comp); ?></th>
				    <th></th>
				    <th><?php //echo number_format($total_fee->total_fee) ?></th>
				    <th></th>
				     <th></th>
                    </tr>
                   </tfoot> -->
