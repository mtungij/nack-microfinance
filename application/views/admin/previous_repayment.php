...
<div class="kt-portlet kt-portlet--mobile">
  <div class="kt-portlet__head kt-portlet__head--lg">
    <?php echo form_open("admin/previour_repayment"); ?>
  ...
  <div class="kt-portlet__head-actions">
    ...
    <?php if(count($repayment) == 0){ ?>
      <?php }else{ ?>
    <a href="<?php echo base_url("admin/print_prev_reportRepayment/{$from}/{$to}/{$comp_id}"); ?>" target="_blank" class="btn btn-brand btn-elevate btn-icon-sm">
      <i class="flaticon-technology"></i>
      Print
    </a>
    <?php } ?>
    <a href="<?php echo base_url("admin/repaymant_data"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
