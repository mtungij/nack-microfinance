...
<head>
<meta charset="utf-8">
<title><?php echo $compdata->comp_name; ?> | PREVIOUS INCOME REPORT</title>
</head>
<body>
...
<p style="font-size:12px;text-align:center;">PREVIOUS INCOME REPORT / From : <?php echo $from; ?> To : <?php echo $to; ?></p>
