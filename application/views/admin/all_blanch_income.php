...
<div class="kt-portlet kt-portlet--mobile">
	<?php echo form_open("admin/all_previous_income"); ?>
	...
	<div class="kt-portlet__head-actions">
		...
		&nbsp;
		  <?php if (count($data)== 0) {
		   ?>
		<?php }else{ ?>
		<a href="<?php echo base_url("admin/print_previous_reportAll/{$from}/{$to}/{$comp_id}"); ?>" target="_blank" class="btn btn-brand btn-elevate btn-icon-sm">
