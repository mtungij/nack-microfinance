 ...
 <div class="kt-portlet kt-portlet--mobile">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
						           ...
						           <?php foreach ($blanch_account as $blanch_accounts): ?>
						             	<tr>
						             		...
						             		<td><?php echo number_format($blanch_accounts->total_blanch_balance); ?></td>
						             		<!-- <td></td> -->
						        ...
						        <tr>
						        	...
						        	<td style="color: orange;"></b><?php echo number_format($total_blanch_capital->total_balanch_amount); ?></b></td>
						        	<!-- <td></td> -->
						        </tr>
                              </table>
	                      </div>
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
						           ...
						           <?php foreach ($today_depost as $today_deposts): ?>
						             	<tr>
						        ...
						        <tr>
						        	...
						        	<td style="color:blue;"><?php echo number_format($total_depostin->total_depostinloan); ?></td>
						        	<!-- <td></td> -->
						        </tr>
						        <tr>
						        	<th>Account Name</th>
						        ...
						        <tr>
						        	<?php foreach ($loan_depost_out as $loan_depost_outs): ?>
						        ...
						        <tr>
						        	...
						        	<td style="color:red;"><?php echo number_format($sum_depost_out->total_deposOutData); ?></td>
						        </tr>
						        <tr>
						        	<td style="color:green;">TOTAL TODAY DEPOST</td>
						        	<td style="color:green;"><?php echo number_format($total_depostin->total_depostinloan + $sum_depost_out->total_deposOutData); ?></td>
						        </tr>
                              </table>
	                      </div>
                       </div>
