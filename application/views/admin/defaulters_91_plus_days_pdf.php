...
<head>
  ...
  <style>
    ...
    th { background: #b71c1c; color: #fff; } /* Dark red header for 91+ days */
    .total-row { background: #f2f2f2; font-weight: bold; }
    .branch-header { background: #ffcdd2; color: #b71c1c; padding: 6px 10px; font-weight: bold; margin-top: 20px; }
    .grand-total { background: #b71c1c; color: #fff; padding: 10px; text-align: center; font-weight: bold; margin-top: 20px; border-radius: 6px; }
    .grand-total-body { background: #ffebee; color: #b71c1c; padding: 12px 16px; display: flex; flex-wrap: wrap; justify-content: space-between; font-size: 12px; border-radius: 4px; }
...
<body>
  ...
  <div class="header">
    ...
    <p><strong><?= $lang_line('pdf_defaulters_91_plus_report', 'Defaulters Report (91+ Days Past Due)') ?></strong></p>
