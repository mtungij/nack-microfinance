...
<head>
  ...
  <style>
    ...
    th { background: #ff9800; color: #fff; } /* Orange header for 61–90 days */
    .total-row { background: #f2f2f2; font-weight: bold; }
    .branch-header { background: #ffe0b2; color: #e65100; padding: 6px 10px; font-weight: bold; margin-top: 20px; }
    .grand-total { background: #ff9800; color: #fff; padding: 10px; text-align: center; font-weight: bold; margin-top: 20px; border-radius: 6px; }
    .grand-total-body { background: #fff3e0; color: #e65100; padding: 12px 16px; display: flex; flex-wrap: wrap; justify-content: space-between; font-size: 12px; border-radius: 4px; }
    .grand-total-item { flex: 1 1 45%; margin-bottom: 6px; min-width: 200px; }
...
<body>
  ...
  <div class="header">
    ...
    <p><strong><?= $lang_line('pdf_defaulters_61_90_report', 'Defaulters Report (61-90 Days Past Due)') ?></strong></p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><b><?= ($outstands->total_deposit >= $outstands->loan_int) ? 0 : $outstands->overdue_days ?></b></td>
