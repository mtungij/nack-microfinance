...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		<a href="<?php echo base_url("admin/print_all_loanCollection"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
									...
									<?php foreach ($loan_collection as $loan_collections): ?>
									          <tr>
				  					<td><?php echo $no++; ?>.</td>
				  					<td class="c"><?php echo $loan_collections->blanch_name; ?> </td>
				  					<td class="c">
