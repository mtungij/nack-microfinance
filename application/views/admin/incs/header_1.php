			...
			<!-- Mirrored from keenthemes.com/metronic/preview/demo12/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2019 17:57:00 GMT -->
			<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
			<head>
			<meta charset="utf-8"/>

			<title>MikopoSoft| <?php 	echo $_SESSION['comp_name'] ?></title>
			...
			<!-- <p>table style</p> -->
			 <!--begin::Page Vendors Styles(used by this page) -->
              <link href="<?php echo base_url() ?>assets/new/assets/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
                        <!--end::Page Vendors Styles -->



	  <link rel="shortcut icon" href="<?php echo base_url() ?>assets/img/logo.png"/style="width: 100px;height: 80px;">
			</head>
			<!-- end::Head -->
