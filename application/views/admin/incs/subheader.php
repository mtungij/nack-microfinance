...
<div class="kt-notification">
    <a href="<?php echo base_url("admin/company_profile"); ?>" class="kt-notification__item">
     ...
     <a href="<?php echo base_url("admin/sms_history"); ?>" class="kt-notification__item">
        <div class="kt-notification__item-icon">
            <i class="flaticon2-envelope kt-font-success"></i>
        </div>
        <div class="kt-notification__item-details">
            <div class="kt-notification__item-title kt-font-bold">
                SMS
    ...
    <div class="kt-notification__custom kt-space-between">
        <a href="<?php echo base_url("welcome/logout"); ?>"  class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
