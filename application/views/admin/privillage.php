...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		...
		<div class="kt-portlet">
			<!--begin::Form-->
				...
				<?php echo form_open("admin/create_Employee_privillage/{$emply->empl_id}",['class'=>'kt-form']) ?>
					...
					<div class="form-group form-group-marginless">
						<div class="row">
							...
							<div class="col-lg-4">
								...
								<a href="<?php echo base_url("admin/delete_priv/{$datas->priv_id}") ?>" style="color:red;" onclick="return confirm('Are you sure?')">Remove</a>				
								</span>										
								</span>
								</span>		
								</label> 
	...
	<div class="modal-footer">
		  <div class="text-center">
                ...
                <a href="<?php echo base_url("admin/all_employee"); ?>" class="btn btn-info">Back</a>
                 </div>
            </div>
            <?php echo form_close(); ?>
</div>
