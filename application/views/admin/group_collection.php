...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				Group Collection Sheet - <?php echo @$blanch_data->blanch_name; ?>
			</h3>
		</div>
	...
	<a href="" class="btn btn-info" class="kt-nav__link" data-toggle="modal" data-target="#kt_modal_4"><i class="kt-menu__link-icon flaticon2-search-1"></i>Filter</a>
		&nbsp;
		<a href="<?php echo base_url("admin/print_group_collection/{$blanch_id}/{$loan_status}") ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
    ...
    <div class="modal-dialog modal-xs" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Group Collections By</h5>
