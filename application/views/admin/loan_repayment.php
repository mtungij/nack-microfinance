...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		&nbsp;
		<a href="<?php echo base_url("admin/previour_repayment"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
			<i class="flaticon-event-calendar-symbol"></i>
			Previous
		</a>
		<a href="<?php echo base_url("admin/print_repayment_report"); ?>" target="_blank" class="btn btn-brand btn-elevate btn-icon-sm">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
									...
									<?php foreach($repayment as $repayments): ?>
				  					...
				  					<td><?php if ($repayments->day == 1) {
				  						...
				  						<?php }elseif($repayments->day == 30 || $repayments->day == 31 || $repayments->day == 28 || $repayments->day == 29){
				  						        echo "Monthly"; 
				  							?>
				  							<?php } ?></td>
