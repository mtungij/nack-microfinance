...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				Loan Disbursed (<?php echo $blanch->blanch_name; ?>)
			</h3>
		</div>
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
									...
									<?php foreach($disburesed as $loan_aproveds): ?>
									          <tr>
				  					...
				  					<td><?php echo number_format($loan_aproveds->loan_aprove + $loan_aproveds->interest_formular/100*$loan_aproveds->loan_aprove); ?></td>
				  					<td><?php if ($loan_aproveds->day == 1) {
				  						...
				  						<?php }elseif($loan_aproveds->day == 30){
				  						        echo "Monthly"; 
				  							?>
				  							<?php } ?></td>
				  					<td><?php echo $loan_aproveds->session ?></td>
				  					<td>
				  			<?php echo number_format(($loan_aproveds->interest_formular/100*$loan_aproveds->loan_aprove + $loan_aproveds->loan_aprove)/($loan_aproveds->session)); ?>
				  					</td>
