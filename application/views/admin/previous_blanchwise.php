...
<div class="kt-portlet kt-portlet--mobile">
	<?php echo form_open("admin/previous_blanchwise_data"); ?>
	...
	<div class="kt-portlet__head-actions">
		...
		<a href="<?php echo base_url("admin/print_previous_blanchwise/{$from}/{$to}/{$comp_id}"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
			<i class="flaticon-technology"></i>
			Print
		</a>
	<?php }else{ ?>
		<?php } ?>
		<a href="<?php echo base_url("admin/blanchiwise_report"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
