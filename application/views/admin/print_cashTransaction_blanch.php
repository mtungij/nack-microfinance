...
<p style="font-size:12px;text-align:center;" class="c"><?php //echo $blanch->blanch_name ?><?php echo $blanch_dataName->blanch_name; ?> - TODAY CASH TRANSACTION REPORT</p>
...
<table>
 ...
 <tr>
   ...
   <td style="font-size:12px;border: none;" class="c"><b><?php echo number_format($sumDepostBlanch->total_depost); ?></b></td>
   <td style="font-size:12px;border: none;" class="c"><b><?php echo number_format($sum_withdrawal->total_with); ?></b></td>
   <td style="font-size:12px;border: none;" class="c"></td>
   <td style="font-size:12px;border: none;" class="c"></td>
 </tr>
