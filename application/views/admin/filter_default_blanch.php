...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				Outstand  Loan Report / <?php echo $blanch_data->blanch_name; ?>
			</h3>
		</div>
	...
	<div class="kt-portlet__head-actions">
		...
		&nbsp;
         ...
         <?php if (count($default_loan) > 0) {
               ?>
         	<a href="<?php echo base_url("admin/print_default_loan/{$blanch_id}"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
								    ...
								    <tbody>
                                          <?php $no = 1; ?>
									<?php foreach ($default_loan as $outstands): ?>
									          <tr>
					...
					<th></th>
					<th></th>
					<th><?php echo number_format($default_blanch_total->total_out); ?></th>
