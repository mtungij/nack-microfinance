    ...
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="mb-6">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-200">
                <?php echo $this->lang->line('manage_share_holders'); ?>
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                <?php echo $this->lang->line('share_holders_desc'); ?>
            </p>
        </div>
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
            <div class="p-4 md:p-6">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-6">
                    <?php echo $this->lang->line('register_share_holder'); ?>
                </h3>
                <?php if ($can_share_edit): ?>
                <?php echo form_open("admin/create_shareHolder", ['novalidate' => true]); ?>
                    <div class="grid sm:grid-cols-12 gap-4 sm:gap-6">
                        <div class="sm:col-span-4">
                            ...
                            <input type="text" id="share_name" name="share_name" placeholder="<?php echo $this->lang->line('full_name_placeholder'); ?>" autocomplete="off" required
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <input type="number" id="share_mobile" name="share_mobile" placeholder="<?php echo $this->lang->line('mobile_no_placeholder'); ?>" autocomplete="off" required
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <input type="email" id="share_email" name="share_email" placeholder="<?php echo $this->lang->line('email_placeholder'); ?>" autocomplete="off" required
                        ...
                        <div class="sm:col-span-6">
                            <label for="share_sex" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('gender'); ?>:</label>
                            <select id="share_sex" name="share_sex" required
                                    data-hs-select='{
                                ...
                                <option value="male" <?php echo set_select('share_sex', 'male'); ?>><?php echo $this->lang->line('male'); ?></option>
                                <option value="female" <?php echo set_select('share_sex', 'female'); ?>><?php echo $this->lang->line('female'); ?></option>
                            </select>
                            <?php echo form_error("share_sex", '<p class="text-xs text-red-600 mt-2">', '</p>'); ?>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="share_dob" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('date_of_birth'); ?>:</label>
                            <input type="date" id="share_dob" name="share_dob" placeholder="Date of Birth" autocomplete="off" required
                            ...
                            <?php echo form_error("share_dob", '<p class="text-xs text-red-600 mt-2">', '</p>'); ?>
                        </div>
                    </div>
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200"><?php echo $this->lang->line('share_holder_list'); ?></h2>
            </div>
            ...
            <div class="p-4" data-hs-datatable='{
                ...
                "language": { "zeroRecords": "<div class=\"py-10 px-5 flex flex-col justify-center items-center text-center\"><svg class=\"shrink-0 size-6 text-gray-500 dark:text-gray-400\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"11\" cy=\"11\" r=\"8\"/><path d=\"m21 21-4.3-4.3\"/></svg><div class=\"max-w-sm mx-auto\"><p class=\"mt-2 text-sm text-gray-600 dark:text-gray-400\"><?php echo $this->lang->line('no_share_holders_found'); ?></p></div></div>" }
            }'>
                <div class="flex flex-wrap items-center justify-between gap-2 mb-4">
                    <div class="relative max-w-xs w-full">
                        <label for="shareholder-table-search" class="sr-only"><?php echo $this->lang->line('search'); ?></label>
                        <input type="text" name="shareholder-table-search" id="shareholder-table-search" class="py-2 px-3 ps-9 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:placeholder-gray-500 dark:focus:ring-gray-600" placeholder="<?php echo $this->lang->line('search_share_holders'); ?>" data-hs-datatable-search="#shareholder_table">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="shareholder_table">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-6 text-start --exclude-from-ordering"><div class="inline-flex items-center gap-x-2"><span class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400"><?php echo $this->lang->line('sex'); ?></span></div></th>
                                        <th scope="col" class="py-3 px-6 text-start --exclude-from-ordering"><div class="inline-flex items-center gap-x-2"><span class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400"><?php echo $this->lang->line('dob'); ?></span></div></th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    <?php $no = 1; ?>
                                    <?php if (isset($share) && is_array($share) && !empty($share)): ?>
        ...
        <?php if ($can_share_edit && isset($share) && is_array($share)): ?>
            <?php foreach ($share as $sh_item): ?>
                ...
                <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all lg:max-w-3xl lg:w-full m-3 lg:mx-auto"> <?php // Wider modal for more fields ?>
                    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                            <h3 class="font-bold text-gray-800 dark:text-white"><?php echo $this->lang->line('edit_share_holder'); ?>: <?php echo htmlspecialchars($sh_item->share_name, ENT_QUOTES, 'UTF-8'); ?></h3>
                            <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" data-hs-overlay="#hs-edit-shareholder-modal-<?php echo $sh_item->share_id; ?>"><span class="sr-only"><?php echo $this->lang->line('close'); ?></span><svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button>
                        </div>
                        <div class="p-4 sm:p-6 overflow-y-auto">
                            <?php echo form_open("admin/modify_shareholder/{$sh_item->share_id}"); ?>
                                <div class="grid sm:grid-cols-12 gap-4 sm:gap-6">
                                    <div class="sm:col-span-4">
                                        <label for="modal_share_name_<?php echo $sh_item->share_id; ?>" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('full_name'); ?>:</label>
                                    ...
                                    <div class="sm:col-span-4">
                                        <label for="modal_share_mobile_<?php echo $sh_item->share_id; ?>" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('mobile_no'); ?>:</label>
                                    ...
                                    <div class="sm:col-span-4">
                                        <label for="modal_share_email_<?php echo $sh_item->share_id; ?>" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('email'); ?>:</label>
                                    ...
                                    <div class="sm:col-span-6">
                                        <label for="modal_share_sex_<?php echo $sh_item->share_id; ?>" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('gender'); ?>:</label>
                                        <select id="modal_share_sex_<?php echo $sh_item->share_id; ?>" name="share_sex" class="py-2.5 px-4 pe-9 input-text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300" required
                                                data-hs-select='{ "placeholder": "<?php echo $this->lang->line('select_gender'); ?>", /* ... hs-select options ... */ }'>
                                            <option value="male" <?php echo ($sh_item->share_sex == 'male') ? 'selected' : ''; ?>><?php echo $this->lang->line('male'); ?></option>
                                            <option value="female" <?php echo ($sh_item->share_sex == 'female') ? 'selected' : ''; ?>><?php echo $this->lang->line('female'); ?></option>
                                        </select>
                                    </div>
                                    <div class="sm:col-span-6">
                                        <label for="modal_share_dob_<?php echo $sh_item->share_id; ?>" class="block text-sm font-medium mb-2 dark:text-gray-300">* <?php echo $this->lang->line('date_of_birth'); ?>:</label>
                                ...
                                <div class="mt-6 flex justify-end items-center gap-x-2 py-3">
                                    <button type="button" class="py-2 px-3 btn-secondary-sm" data-hs-overlay="#hs-edit-shareholder-modal-<?php echo $sh_item->share_id; ?>"><?php echo $this->lang->line('close'); ?></button>
                                    <button type="submit" class="py-2 px-3 btn-primary-sm bg-cyan-600 hover:bg-cyan-700 text-white"><?php echo $this->lang->line('update'); ?></button>
                                </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
