                ...
                <?php echo form_open("admin/create_shareHolder", ['novalidate' => true]); ?>
                    <div class="grid sm:grid-cols-12 gap-4 sm:gap-6">
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <input type="number" id="share_mobile" name="share_mobile" placeholder="Mobile no" autocomplete="off" required
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <input type="email" id="share_email" name="share_email" placeholder="Email" autocomplete="off" required
                        ...
                        <div class="sm:col-span-6">
                            <label for="share_sex" class="block text-sm font-medium mb-2 dark:text-gray-300">* Gender:</label>
                            <select id="share_sex" name="share_sex" required
                                ...
                                <option value="male" <?php echo set_select('share_sex', 'male'); ?>>Male</option>
                                <option value="female" <?php echo set_select('share_sex', 'female'); ?>>Female</option>
                            </select>
                            <?php echo form_error("share_sex", '<p class="text-xs text-red-600 mt-2">', '</p>'); ?>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="share_dob" class="block text-sm font-medium mb-2 dark:text-gray-300">* Date of Birth:</label>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="shareholder_table">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-6 text-start --exclude-from-ordering"><div class="inline-flex items-center gap-x-2"><span class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400">Sex</span></div></th>
                                        <th scope="col" class="py-3 px-6 text-start --exclude-from-ordering"><div class="inline-flex items-center gap-x-2"><span class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400">DOB</span></div></th>
