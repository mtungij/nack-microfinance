...
<div class="w-full lg:ps-64">
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="mb-6">
			...
			This section allows you to register new daily expenses by entering their names. Use the form below to add an expense, which will then appear in the account list for management.
            </p>
        </div>
...
<div class="grid sm:grid-cols-12 gap-4 sm:gap-6">
                        ...
                        <div class="sm:col-span-8">
                            <label for="account_name" class="block text-sm font-medium mb-2 dark:text-gray-300">* Expenses Name:</label>
                            <input type="text" id="account_name" name="ex_name" placeholder="e.g.umeme,posho n.k" autocomplete="off" required
            ...
            <div class="p-4" data-hs-datatable='{
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 mb-4">
                    <div class="relative max-w-xs w-full">
                        <label for="account-table-search" class="sr-only">Search</label>
                        <input type="text" name="account-table-search" id="account-table-search" class="py-2 px-3 ps-9 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-cyan-500 focus:ring-cyan-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:placeholder-gray-500 dark:focus:ring-gray-600" placeholder="Search accounts..." data-hs-datatable-search="#account_table">
									...
									<?php foreach ($exp as $exps): ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                                <a href="<?php echo base_url("admin/delete_expenses/{$exps->ex_id}"); ?>" onclick="return confirm('Are you sure you want to delete this account?');" class="inline-flex items-center gap-x-1.5 text-sm font-semibold rounded-lg border border-transparent text-red-600 hover:text-red-800 disabled:opacity-50 disabled:pointer-events-none dark:text-red-500 dark:hover:text-red-400">
