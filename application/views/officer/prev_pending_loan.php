...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		?>
	<?php }else{ ?>
		<a href="<?php echo base_url("admin/print_prevPendloan/{$from}/{$to}/{$blanch_id}"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
			<i class="flaticon-technology"></i>
			Print
		</a>
		<?php } ?>
		<a href="<?php echo base_url("oficer/manager_loan_pending_time"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
