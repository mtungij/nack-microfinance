	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("oficer/create_income",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="<?php echo base_url("oficer/delete_income/{$incomes->inc_id}") ?>" class="kt-nav__link" onclick="return confirm('Are you sure?')">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open("oficer/modify_income/{$incomes->inc_id}"); ?>
