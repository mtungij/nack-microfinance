...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<b>General manager Panel</b> - <b><?php echo $manager_data->comp_name; ?></b>  <b><?php //echo $manager_data->blanch_name; ?></b> <?php //echo $_SESSION['empl_name']; ?>                </h3>
				...
				<div class="kt-invoice__head" style="background-image: url('<?php echo base_url() ?>assets/img/pi.png');">
					<div class="kt-invoice__container kt-invoice__container--centered">
						<div class="kt-invoice__logo">
							<a href="#">
								<h1><?php echo number_format(($loanAprove->total_loanAprove - $withdrawal->withdrawal_amount - $request_expences->total_exp)  + ($loan_depost->Total_depost + $receive_Amount->total_receve_amaount)); ?> - Opening Balance (<?php echo $blanch_datas->blanchNic_name; ?>)</h1>
							</a>
						</div>
						...
						<div class="kt-invoice__items">
								...
								<span class="kt-invoice__text"><b><?php echo number_format($income->total_incomeBlanch + $loan_fee->sum_withdraw); ?></b></span>
							</div>
