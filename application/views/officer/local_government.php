	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("oficer/Update_local_govDetails/{$loan_attach->loan_id}/{$local_gov->attach_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
					...
					<div class="kt-form__actions">
						<div class="row">
							<div class="col-lg-12">
								...
								<a href="<?php echo base_url("oficer/loan_pending"); ?>" class="btn btn-info btn-elevate btn-pill btn-sm">Finish</a>
								</div>
							</div>
						</div>
					</div>
...
<div class="row">
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!--begin::Form-->
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open_multipart("oficer/create_local_govDetails/{$loan_attach->loan_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
				<div class="kt-portlet__body">
					<div class="kt-section">
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
