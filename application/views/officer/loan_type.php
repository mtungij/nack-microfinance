    ...
    <div class="p-4 sm:p-6 space-y-6">
        ...
        <div class="mb-6">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-200">
               Tafuta mteja kwa ajili kumuombea mkopo
            </h2>
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
            <div class="p-4 md:p-6">
                ...
                <?php echo form_open("oficer/start_loan_application", ['novalidate' => true]); ?>
                 
                    
                        <!-- Branch Select2 Dropdown -->
						<div class="col-span-12">
    <label for="branchSelect" class="block text-sm font-medium mb-2 dark:text-gray-300">*Select customer:</label>
    <select id="branchSelect" name="loan_type"  required name="customer_id"
        ...
        <option value="individual">Mkopo wa Mteja Mmoja (Individual)</option>
        <option value="group">Mkopo wa Kikundi cha Wateja</option>
    </select>
</div>
