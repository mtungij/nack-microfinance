...
<div class="kt-notification">
    <a href="<?php echo base_url("oficer/oficer_profile"); ?>" class="kt-notification__item">
    ...
    <div class="kt-notification__custom kt-space-between">
        <a href="<?php echo base_url("welcome/empl_logout"); ?>"  class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
