...
<div class="kt-portlet kt-portlet--mobile">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<?php echo form_open("oficer/manager_prevTransaction"); ?>
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
			 ...
			 <input type="hidden" value="<?php echo $empl_data->comp_id; ?>" name="comp_id"> 
			<h3 class="kt-portlet__head-title">
				<br>
	...
	<div class="kt-portlet__head-actions">
        ...
        <?php if (count($data) == 0) {
         ?>
     <?php }else{ ?>
		<a href="<?php echo base_url("oficer/Manager_print_previous_cash/{$from}/{$to}/{$comp_id}"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
			<i class="flaticon-technology"></i>
			Print
		</a>
		<?php } ?>

		<a href="<?php echo base_url("oficer/manager_cashTransaction"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
									...
									<?php foreach ($data as $cashs): ?>
				  					...
				  					<td class="c"><?php echo $cashs->blanch_name; ?></td>
				  					<td>
