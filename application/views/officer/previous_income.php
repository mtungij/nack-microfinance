	...
	<div class="kt-portlet__head-actions">
		...
		&nbsp;
		  <?php if (count($data)== 0) {
		   ?>
		<?php }else{ ?>
		<a href="<?php echo base_url("oficer/print_previous_report/{$from}/{$to}/{$comp_id}/{$blanch_id}"); ?>" target="_blank" class="btn btn-brand btn-elevate btn-icon-sm">
			<i class="flaticon-technology"></i>
			Print
		</a>
		<?php } ?>

		<a href="<?php echo base_url("oficer/all_previous_income"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
