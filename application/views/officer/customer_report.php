...
<div class="kt-portlet kt-portlet--mobile">
   ...
   <div class="kt-portlet__head kt-portlet__head--lg">
    ...
    <br>
        &nbsp;
        <a href="<?php echo base_url("oficer/print_customer_loan_report/{$customer_id}"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
            <i class="flaticon-technology"></i>
            Print
        </a>
        <a href="<?php echo base_url("oficer/search_customer_loan_report"); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
...
<?php }else{ ?>
	...
	<h1>
        <br><br><br>
OOPS!  There no Report with that name</h1>
<?php if ($manager->position_id == '21') {
 ?>
      <a href="<?php echo base_url("oficer/manager_search_customer_loan_report"); ?>" class="btn btn-info">Back</a>
  <?php }else{ ?>
      <a href="<?php echo base_url("oficer/search_customer_loan_report"); ?>" class="btn btn-info">Back</a>
