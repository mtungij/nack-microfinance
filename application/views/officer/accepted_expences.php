...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__head-actions">
		...
		&nbsp;
		<a href="<?php echo base_url("oficer/print_accepted_expences"); ?>" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
...
<?php endforeach; ?>
                    ...
                    <tr>
                   	<th>Total</th>
				    <th></th>
				    <th><?php echo number_format($total_req->total_reqExp); ?></th>
				    <th> </th>
				    <th></th>
				    <th></th>
				     <th></th>
