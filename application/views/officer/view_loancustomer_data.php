...
<?php endforeach; ?>
		...
		<!--end: Datatable -->
	          ...
	          <div class="text-center">
		          	<h4>MEMBER GROUP LIST (<b><?php echo $group->group_name; ?></b>)</h4>
		          </div>
		          <div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
									...
									<?php foreach($member_data  as $member_datas): ?>
									          <tr>
				  					<td><?php echo $no++; ?>.</td>
				  					<td><?php echo $member_datas->member_name; ?></td>
				  					<td><?php echo $member_datas->member_phone; ?> </td>
				  					<td><?php echo $member_datas->gender; ?> </td>
				  					<td><?php echo $member_datas->nature_setlement; ?></td>
				  					<td><?php echo $member_datas->martial_status; ?></td>
				  					<td><?php echo $member_datas->district; ?></td>
				  						<td><?php echo $member_datas->ward; ?></td>
				  						<td><?php echo $member_datas->street; ?></td>
...
<div class="text-center">
	...
	<div class="col-lg-12">
		<div class="kt-portlet">
				 ...
				 <?php echo form_open("oficer/aprove_loan/{$loan_form->loan_id}",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
				<div class="kt-portlet__body">
					<div class="kt-section">
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
							...
							<input type="text" name="" placeholder="Ward" autocomplete="off" class="form-control input-sm" value="<?php echo @$local_oficer->ward_oficer; ?>" readonly>
							   ...
							   <a href="javascript:;" class="btn btn-danger"><i class="flaticon-attachment"></i>No Loan Agreement</a>
								...
								<div class="col-lg-4 form-group-sub">
							     ...
							     <img src="<?php echo base_url().'assets/img/'.$collaterals->file_name; ?>" class="img-thumbnail">
								</div>
								<?php endforeach; ?>
							</div>
						</div>
