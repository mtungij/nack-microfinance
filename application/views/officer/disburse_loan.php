...
<div class="w-full lg:ps-64">
  <div class="= overflow-x-auto">
   ...
   <div class="mb-6  mr-1.5" >
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-200">
                Approved Loans
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                ready for Withdrawal            </p>
        </div>
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
    ...
    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
            ...
            <th scope="col" class="px-4 py-3">Collection</th>
            <th scope="col" class="px-4 py-3">Disburse Date</th>
    ...
    <tbody>
        ...
        <?php foreach($disburse as $loan_aproveds): ?>
            <tr class="border-b dark:border-cyan-700">
                ...
                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $loan_aproveds->phone_no; ?></td>
                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo number_format($loan_aproveds->loan_aprove); ?></td>
                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo number_format($loan_aproveds->loan_int); ?></td>
                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo number_format($loan_aproveds->restration); ?></td>
                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <?php
                        $label = '';
                       ...
                       class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-cyan-600 hover:bg-cyan-700 rounded-lg shadow-sm">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-7a2 2 0 012-2h16a2 2 0 012 2v7a2 2 0 01-2 2h-2m-4 0h-4v4h4v-4z"/>
                        </svg>
                        Print Mkataba
                    </a>
                    <?php endif; ?>
