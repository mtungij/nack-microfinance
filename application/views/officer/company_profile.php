...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet__body">
        ...
        <!-- <form action="#" method=""> -->
        	<?php echo form_open_multipart("oficer/modify_empl_account/{$empl_data->empl_id}"); ?>
                                ...
                                <div class="kt-section__body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <h3 class="kt-section__title kt-section__title-sm">Parsonal information:</h3>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">User Profile pc</label>
                                        <div class="col-lg-9 col-xl-6">
                                          ...
                                          <div class="kt-avatar__holder" style="background-image: url('<?php echo base_url(); ?>assets/img/user.png');"></div>
                                                ...
                                                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change avatar">
                                                    <i class="fa fa-pen"></i>
                                                 <!--    <input type="hidden" name="comp_logo" accept=".png, .jpg, .jpeg" required> -->
                                                </label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">Employee name</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control" readonly name="empl_name" type="text" value="<?php echo $empl_data->empl_name; ?>">
                                        </div>
                                    </div>
                               
                               
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">Employee Phone</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text"><i class="la la-phone"></i></span></div>
                                                <input type="number" name="empl_no" readonly class="form-control" value="<?php echo $empl_data->empl_no; ?>" placeholder="Phone" aria-describedby="basic-addon1">
                                            </div>
                                            
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">Employee Email</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text"><i class="la la-at"></i></span></div>
                                                <input type="email" readonly name="empl_email" class="form-control" value="<?php echo $empl_data->empl_email; ?>" placeholder="Email" aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-group-last row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                           <select type="number" name="empl_sex" readonly class="form-control">
                                           	<option value="<?php echo $empl_data->empl_sex; ?>"><?php echo $empl_data->empl_sex; ?></option>
