	...
	<div class="col-lg-12">
		<div class="kt-portlet">
			...
			<!-- <form method="post" action="ss" class="kt-form kt-form--label-right" id="kt_form_2"> -->
				<?php echo form_open("admin/create_account",['class'=>'kt-form kt-form--label-right','novalidate']); ?>
						...
						<div class="kt-section__content">
							<div class="form-group form-group-last row">
								...
								<div class="col-lg-6 form-group-sub">
									...
									<input type="text" name="account_name" autocomplete="off" class="form-control" required placeholder="Account name" name="billing_state" placeholder="" value="">
								</div>
								<div class="col-lg-3 form-group-sub">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<ul class="kt-nav">
					...
					<li class="kt-nav__item">
						<a href="#" class="kt-nav__link" data-toggle="modal" data-target="#kt_modal_<?php echo $accounts->account_id; ?>">
