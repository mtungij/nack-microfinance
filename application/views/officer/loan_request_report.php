...
<head>
  <meta charset="utf-8">
  <title><?php echo $compdata->comp_name; ?> | LOAN DISBURSEMENT REQUEST REPORT</title>
</head>
<body>
 ...
 <div style="width: 20%;">
  ...
  <p style="font-size:20px;" class="c"> <b><?php echo $compdata->comp_name; ?></b><br>
        ...
        <?php $day = date("d-m-Y"); ?>
         ...
         <p style="font-size:15px;text-align:center;"><b><?php echo $blanch_data->blanch_name; ?> - LOAN DISBURSEMENT REQUEST REPORT</b>(<i>Individual</i>) / <?php echo $day; ?></p>
...
<table>
  <tr>
    ...
    <th style="font-size:12px;border: none;">Date</th>
           ...
           <?php $no = 1; ?>
  <?php foreach ($loan_pending as $repayments): ?>
