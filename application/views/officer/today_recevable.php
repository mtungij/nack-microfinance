  ...
  <table id="shareholder_table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
		...
		<?php $sno = 1; ?>
     	<?php foreach($today_recevable as $today_recevables): ?>
                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td class="uppercase px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $today_recevables->f_name; ?> <?php echo $today_recevables->m_name; ?> <?php echo $today_recevables->l_name; ?></td>
                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $today_recevables->phone_no; ?></td>
                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo number_format($today_recevables->loan_int); ?></td>
	...
	<?php if ($today_recevables->day == 1) {
				  						...
				  						<?php }elseif($today_recevables->day == 30 || $today_recevables->day == 31 || $today_recevables->day == 28 || $today_recevables->day == 29){
											...
											<?= $today_recevables->session ?>
					</td>
					
				

					<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
						<?php echo $today_recevables->restration; ?>
					</td>
